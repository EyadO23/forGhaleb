...
public function storeApi(Request $request)
{
    ...
    if (!$hasProfile) {
        return response()->json(['message' => 'please fill your information'], 200);
    }
...
public function updateApi(Request $request, $id)
{
    ...
    if ($request->has('final_bid_score') && $request->input('final_bid_score') !== 'null') {
        $data['final_bid_score'] = $request->input('final_bid_score');
    }

...
{
    $tenders = Tender::where('status', 'opened')->paginate(10); 
...
$bid = Bid::with('contractor.user')->find($request->bid_id);
...
try {
    ...
    app(ContractorController::class)->generateContractPdf
    ($bid->contractor_id, $tender->id, $bid->id);
    ...
    return response()->json([
        ...
        'user_id' => $bid->contractor->user->id,
